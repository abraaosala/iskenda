...
export const SERVICES: Service[] = [
  {
    ...
    title: "Contabilidade",
    description:
      "Organização e controle financeiro de excelência para guiar a sua empresa na tomada de decisões estratégicas fundamentadas.",
    icon: "Calculator",
    features: [
  ...
  },
  {
    ...
    description:
      "Conformidade integral com toda a legislação tributária angolana, mitigando riscos fiscais e otimizando a carga de impostos legalmente.",
    icon: "FileText",
    features: [
  ...
  },
  {
    ...
    description:
      "Gestão completa do seu capital humano, assegurando processos legais, operacionais e motivacionais alinhados à Lei Geral do Trabalho.",
    icon: "Users",
    features: [
  ...
  },
  {
    ...
    description:
      "Padronização e otimização dos fluxos operacionais internos, eliminando desperdícios de tempo e burocracia desordenada.",
    icon: "Layers",
    features: [
...
export const VALUES: CompanyValue[] = [
  {
    title: "Ética",
    description:
      "Conduzir todas as ações com ética absoluta, retidão profissional e respeito estrito aos regulamentos do mercado de Angola.",
    icon: "ShieldAlert",
  },
  {
    title: "Integridade",
    description:
      "Construir relações de extrema confiança assentes na honestidade e transparência mútua, sem margem para dúvidas.",
    icon: "CheckCircle2",
  },
  {
    title: "Excelência",
    description:
      "Prestar serviços de nível internacional com precisão rigorosa e atenção total a cada detalhe das contas da sua empresa.",
    icon: "Award",
  },
  {
    title: "Responsabilidade",
    description:
      "Comprometer-se integralmente com o cumprimento dos prazos fiscais e legais, assumindo uma postura ativa e de vanguarda.",
    icon: "UserCheck",
  },
  {
    title: "Transparência",
    description:
      "Comunicação claríssima em torno de honorários, termos contratuais e resultados financeiros obtidos para a corporação.",
    icon: "Eye",
  },
  {
    title: "Inovação",
    description:
      "Adotar processos modernos inteligentes, automações digitais e ferramentas computacionais inovadoras no tratamento contabilístico.",
    icon: "Lightbulb",
  },
  {
    title: "Compromisso",
    description:
      "Foco integral no crescimento e sustentabilidade das empresas parceiras, alinhando objetivos no curto, médio e longo prazo.",
    icon: "Handshake",
  },
];
...
export const ACADEMIA_COURSES: Course[] = [
  {
    ...
    description:
      "Formação intensa focada no quotidiano real de uma contabilidade empresarial, desde a inserção de documentos até à elaboração de relatórios.",
    icon: "Calculator",
    modules: [
  ...
  },
  {
    ...
    duration: "32 Horas",
    description:
      "Domine todos os impostos vitais exigidos pela AGT. Submeta declarações de impostos sem margem de erro legal e aprenda a otimização fiscal preventiva.",
  ...
  },
  {
    ...
    duration: "30 Horas",
    description:
      "Aprenda a processar salários e a gerir as obrigações com a Segurança Social angolana, além de elaborar contratos alinhados com a LGT.",
    icon: "Users",
    modules: [
  ...
  },
  {
    ...
    duration: "20 Horas",
    description:
      "Estratégias de fidelização e técnicas modernas de comunicação interpessoal essenciais para conquistar e reter clientes corporativos e individuais.",
    icon: "MessageSquare",
    modules: [
...
export const ACADEMIA_OFFERS: AcademyOffer[] = [
  {
    ...
    description:
      "Salas de aula climatizadas com postos de computador dedicados para exercícios práticos em softwares reais.",
    icon: "School",
  },
  {
    title: "Formação Online",
    description:
      "Aulas dinâmicas ao vivo integrando suporte remoto interativo, permitindo-lhe estudar a partir de qualquer província de Angola.",
    icon: "Laptop",
  },
  {
    title: "Estágio Profissional",
    description:
      "Oportunidade estrita dos alunos de destaque ingressarem no departamento de consultoria empresarial da IS KENDA para uma imersão prática.",
    icon: "Briefcase",
  },
  {
    title: "Acompanhamento Prático",
    description:
      "Mentoria personalizada com consultores seniores em atividade continuada no mercado de negócios angolano.",
    icon: "TrendingUp",
  },
  {
    title: "Certificado Homologado",
    description:
      "Certificado formal de participação profissional, impulsionando decisivamente o seu currículo nas plataformas e processos de seleção.",
    icon: "Award",
  },
];
...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    description:
      "Lidera a estratégia corporativa da IS KENDA com mais de 10 anos de experiência em consultoria empresarial e gestão financeira em Angola.",
    initials: "JM",
  ...
  },
  {
    ...
    description:
      "Especialista em PGC angolano e encerramento de contas, garante a conformidade contabilística de todas as empresas parceiras.",
    initials: "MS",
  ...
  },
  {
    ...
    description:
      "Perito em regime tributário angolano, assegura a submissão correta de IVA, IRT e Imposto Industrial junto à AGT.",
    initials: "CF",
  ...
  },
  {
    ...
    description:
      "Responsável pelo processamento salarial, gestão de contratos e conformidade com a Lei Geral do Trabalho de Angola.",
    initials: "AC",
  ...
  },
  {
    ...
    description:
      "Estrutura e otimiza os fluxos documentais e processos administrativos internos das empresas parceiras.",
    initials: "MD",
  ...
  },
  {
    ...
    description:
      "Lidera a IS KENDA Academia, desenhando currículos e coordenando formações profissionais alinhadas ao mercado angolano.",
    initials: "HQ",
...
export const SOCIAL_LINKS: SocialLink[] = [
  ...
  { platform: "Facebook", icon: "Facebook", url: "https://www.facebook.com/geraliskenda/" },
  {
    platform: "LinkedIn",
    icon: "Linkedin",
    url: "https://ao.linkedin.com/in/academia-is-kenda-71a309370",
  },
];
