...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        const msg =
          res.status === 401 ? "Credenciais inválidas." : "Erro do servidor. Tente novamente.";
        throw new Error(msg);
      }
        ...
        <div className="hidden lg:flex w-[440px] min-h-screen bg-gradient-to-br from-brand-navy via-brand-blue to-brand-navy flex-col justify-between p-12 relative overflow-hidden">
          ...
          <div className="relative">
            ...
            <p className="text-sm text-white/50 mt-2 max-w-[280px] leading-relaxed">
              Consultoria & Academia — Soluções empresariais para o crescimento do seu negócio em
              Angola.
            </p>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-12 bg-slate-50">
          <div className="w-full max-w-md">
            ...
            <div className="lg:hidden text-center mb-10">
              ...
              <h1 className="text-xl font-extrabold text-brand-navy tracking-tight">IS KENDA</h1>
            ...
            <div className="bg-white rounded-2xl shadow-xl border border-slate-200 p-8 sm:p-10">
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-500 mt-1">Aceda ao painel administrativo</p>
              </div>
