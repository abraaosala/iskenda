        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
            ...
            <p id="contact-intro" className="text-sm sm:text-base text-slate-500 max-w-2xl mx-auto">
              Agende uma reunião diagnóstica gratuita ou tire dúvidas sobre as turmas da nossa
              academia. A nossa equipa responderá em tempo recorde.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-5 space-y-6 flex flex-col justify-between">
              <div
                ...
                className="bg-white p-8 rounded-3xl border border-slate-200 space-y-8 flex-1"
              >
                <div>
              ...
              <div
                id="contact-map-card"
                className="h-64 rounded-3xl overflow-hidden border border-slate-200 shadow-sm relative"
              >
                <iframe
                  id="contact-map"
            ...
            <div className="lg:col-span-7">
              <div
                ...
                className="bg-slate-900 text-white p-8 sm:p-10 rounded-3xl shadow-xl relative overflow-hidden h-full"
              >
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-sm text-slate-350 max-w-md leading-relaxed">
                      Muito obrigado por entrar em contacto com a <strong>IS KENDA</strong>.
                      Recebemos as suas informações e responderemos por telefone ou e-mail dentro de
                      24 horas úteis.
                    </p>
                    <button
                  ...
                  <form id="contact-actual-form" onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                      <div className="space-y-2">
                        <label
                          htmlFor="nome"
                          className="text-xs font-bold text-slate-350 uppercase tracking-wider block text-left"
                        >
                          Nome Completo *
                        </label>
                        <input
                    ...
                    <div className="pt-4 flex flex-col sm:flex-row items-center justify-between gap-4">
                      <span className="text-[10px] text-slate-450 text-left">
                        * Ao submeter este formulário, concorda com a recolha segura das suas
                        informações sob a nossa política de confidencialidade de Angola.
                      </span>
                      {submitError && (
