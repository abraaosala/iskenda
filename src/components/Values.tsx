...
export default function Values() {
  return (
    <section id="valores" className="py-24 bg-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-80 h-80 bg-brand-azure/5 rounded-full filter blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div id="values-tag" className="inline-flex items-center space-x-2 bg-brand-gold/10 px-4 py-1.5 rounded-full text-brand-gold text-xs font-extrabold uppercase tracking-wider">
              ...
              >
                <div>
                  <div className="flex items-center justify-between mb-5">
                    <div className="p-3 bg-white rounded-xl text-brand-royal border border-slate-200/60 shadow-xs group-hover:bg-brand-royal group-hover:text-white transition-all duration-350">
                  ...
                  <h3 className="text-lg font-bold text-slate-950 mb-2 group-hover:text-brand-royal transition-colors font-sans">
                    {value.title}
                  </h3>
                ...
                <div className="mt-6 pt-4 border-t border-slate-200/40 flex justify-between items-center text-[10px] font-mono text-slate-400 font-semibold tracking-wider">
                  ...
                  <span className="text-[10px] text-brand-royal/60 group-hover:text-brand-royal font-bold tracking-wide flex items-center space-x-1 uppercase transition-colors">
