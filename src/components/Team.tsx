...
export default function Team() {
  ...
  return (
    <section id="equipa" className="py-24 bg-white relative overflow-hidden">
      <div className="absolute top-1/3 -right-20 w-80 h-80 bg-brand-royal/5 rounded-full filter blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -left-20 w-72 h-72 bg-brand-gold/5 rounded-full filter blur-3xl pointer-events-none" />
                ...
                <div className="p-7 pt-5 flex flex-col flex-1">
                  <div className="flex items-center space-x-2 mb-1">
                    ...
                    <span className={`text-[10px] font-bold uppercase tracking-wider transition-colors duration-300 ${
                      isHovered ? "text-brand-gold" : "text-brand-azure"
                    }`}>
                      {member.role}
                    </span>
                  </div>
